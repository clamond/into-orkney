...
<div class="mainContent">
	<div>Use the map below to choose the place that you would like to edit.</div>
	<div class="mainArea">
	<div class="search">
	<div class="heading" style="height:30px;">intoOrkney sites CMS - select site you want to edit</div>
